...
export function update(nome_turma,turno,id, callback){
    connection.query('UPDATE turmas SET NOME_TURMA = ?, ACTIVO_TURMAS = 1 WHERE COD_TURMA = ?', [nome_turma,turno,id], callback)
}
